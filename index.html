  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-primary fs-4 ps-2">Nusantara Indonesia</span></a>
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              <h1 class="mb-4 display-1 lh-sm">Holiday with <br class="d-block d-lg-none d-xl-block" />Nusantara Indonesia</h1>
              <p class="mt-4 mb-5 fs-1 lh-base"> Rencanakan dan pesan perjalanan sempurna Anda dengan Nusantara Indonesia,<br class="d-none d-lg-block" />tips perjalanan, informasi tujuan dan
                <br class="d-none d-lg-block" /> inspirasi dari kami.</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">Sign Up Now</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row flex-md-center">
            <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
              ...
              <p class="lh-lg">Memasuki tahun 2021, minat masyarakat untuk melakukan perjalanan wisata terhitung cukup tinggi. Berdasarkan survei internal, 35% responden berminat untuk berlibur di awal tahun 2021. Tentunya hal ini didukung dengan perubahan minat dan perilaku masyarakat khususnya dalam berwisata yang semakin terbentuk.</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">Explore</a>
            </div>
                  ...
                  <div class="carousel-item active">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/aa.png" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp.3.500.000</span></div>
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/bb.png" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp.7.000.000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/cc.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp.5000.000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                  ...
                  <div class="carousel-item">
                    <div class="row h-100">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/cc.jpg" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp.5.000.000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Raja Ampat</h5>
                  ...
                  <div class="carousel-item">
                    <div class="row h-100">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/bb.png" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary"><Rp class="6 5"></Rp>00.000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Bali</h5>
                              <h6 class="text-600">7 days</h6>
                            </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              ...
              <p class="mx-auto">Dengan lebih dari 18000 pulau, Indonesia adalah negara kepulauan terbesar di dunia. Negara kepulauan ini adalah rumah bagi 167 gunung berapi aktif, jauh lebih banyak daripada negara lain dan memiliki sebagian hutan tropis terbesar yang tersisa di dunia. Indonesia adalah impian pencari rekreasi dan taman bermain petualang. Baik Anda mencari perunggu di pantai yang indah, mendaki untuk mencari orangutan yang terancam punah, atau snorkeling di antara beberapa terumbu karang terindah di Bumi, negara ini memiliki sesuatu untuk semua orang. Berikut ini beberapa tempat terbaik untuk dikunjungi di Indonesia</p>
            </div>
          </div>
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active h-100">
                        <div class="player" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY">
                          <iframe src="https://youtu.be/vLKusPNw_Vg" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        </div>
                      </div>
                      <div class="carousel-item">
                        <div class="player" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY">
                          <iframe src="https://youtu.be/zHcr32gRRCs" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        </div>
                      </div>
                      <div class="carousel-item">
                        <div class="player" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY">
                          <iframe src="https://youtu.be/rGEkMJwVnZU" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        </div>
                      </div>
                      <div class="carousel-item">
                        <div class="player" data-plyr-provider="youtube" data-plyr-embed-id="bTqVqk7FSmY">
                          <iframe src="https://youtu.be/pBVkt4ZGnlQ" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="carousel-indicators">
                      <div class="row h-100 w-100">
                        <div class="col-12 px-1">
                          <button class="active" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"><img class="d-block" src="assets/img/gallery/rsz_aa.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"><img class="d-block" src="assets/img/gallery/rsz_bb.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3"><img class="d-block" src="assets/img/gallery/rsz_beaches.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4"><img class="d-block" src="assets/img/gallery/rsz_indonesia.png" alt="..." /></button>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2 active" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-dark"> Trip To Labuan Bajo</p>
                            <p class="card-text"><small class="text-800">03.50</small></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-500">Destination Bali </p>
                            <p class="card-text"><small class="text-800">02.35</small></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-500"> Beautiful Place Raja Ampat</p>
                            <p class="card-text"><small class="text-800">03.43</small></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-3" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-500"> Biography Nusantara Indonesia</p>
                            <p class="card-text"><small class="text-800">03.58 </small></p>
                          </div>
                        </div>
                      </div>
                    </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              ...
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Menawarkan berbagai macam paket liburan di Indonesia untuk liburan keluarga, adventur, group incentive, dll dengan akomodasi di bermacam hotel bagi para wisatawan yang sedang merencanakan perjalanan mereka.</p>
            </div>
          </div>
                    ...
                    <div class="col-12 col-lg-7 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body d-flex flex-center flex-column">
                          <p class="text-center card-text mb-5">“Ikut TOW yang ke-4 kalinya, pastinya happy banget, ini jadi pengalaman pertama kali lagi untuk keluar rumah dengan protokol kesehatan dan segala adaptasi new normal. Tapi disisi lain juga sedih karena liat anjloknya pariwisata Indonesia.” </p>
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/rsz_yom.jpg" alt="" /></div>
                          </div>
                          <div class="mt-3 text-center">
                            <h6 class="text-1000 fw-bold">Mario Rizky</h6>
                            <p class="fs--1 fw-normal mb-0">Influencer</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="carousel-item" data-bs-interval="2000">
                  <div class="row h-100 flex-center">
                    <div class="col-12 col-lg-7 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body d-flex flex-center flex-column">
                          <p class="text-center card-text mb-5">“Indonesia is a lovely country, very kind,quiet and helpful people, especially when i visited a small cities, islands, I could feel a warm love from every one, people did their best to make me happy, I did really feel home in there, only one little problem was that people do not speak English only few of them. on the other hand that gave me the chance to be thankful to the way they treated me by learning their language to communicate with them.” </p>
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/rsz_fira.jpg" alt="" /></div>
                          </div>
                          <div class="mt-3 text-center">
                            <h6 class="text-1000 fw-bold">Syafira Adiba</h6>
                ...
                <div class="carousel-item" data-bs-interval="3000">
                  <div class="row h-100 flex-center">
                    <div class="col-12 col-lg-7 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body d-flex flex-center flex-column">
                          <p class="text-center card-text mb-5">“There’s still so much of Indonesia I haven’t been to, of course. I admit, I’ve only been to Medan (and all the way to the awesome Lake Toba), Padang and Bukittinggi, Palembang (and its Pulau Bangka), Jakarta, Bogor, Bandung, Jogjakarta, Surabaya, Bali island and a very memorable Harley-Davidson convoy ride from Surabaya to Banyuwangi, the easternmost tip of Jawa Island, before hopping on to a boat to ride around Bali, and back again to Surabaya after a few smashing days in Bali. Oh yeahhh!!” </p>
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/rsz_sherin.jpg" alt="" /></div>
                          </div>
                          <div class="mt-3 text-center">
                            <h6 class="text-1000 fw-bold">Sherin Dwi Appriliani</h6>
                            <p class="fs--1 fw-normal mb-0">Traveller</p>
                          </div>
                        </div>
                      </div>
                ...
                <div class="carousel-item">
                  <div class="row h-100 flex-center">
                    <div class="col-12 col-lg-7 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body d-flex flex-center flex-column">
                          <p class="text-center card-text mb-5">“Indonesia is an amazing and beautiful, if frequently tragic, place. The children are lovely and sweet and the adults humble and unfailingly polite. I count it as an essential destination.” </p>
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center"><img class="img-fluid" src="assets/img/gallery/rsz_yom.jpg" alt="" /></div>
                          </div>
                          <div class="mt-3 text-center">
              ...
              <form class="row gy-2 gx-md-2 gx-lg-4 flex-center my-6">
                <div class="col-6 col-md-3">
                  ...
                  <select class="form-select" id="inlineFormSelectPref">
                    ...
                    <option value="3">Raja Ampat</option>
                  </select>
                </div>
                <div class="col-6 col-md-3">
      ...
      <section class="py-6">
        ...
        <div class="container">
          ...
          <div class="row flex-center">
            <div class="col-auto mb-4">
              <p class="mb-0 fs--1 text-dark">UNIVERSITAS MUHAMMADIYAH MALANG
                ...
                </svg>&nbsp;by&nbsp;<a class="text-700" href="https://themewagon.com/" target="_blank"> </a>
              </p>
            </div>
          </div>
          <div class="row flex-center">
